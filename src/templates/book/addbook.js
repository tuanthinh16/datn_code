    ...
    <div id="mainctn">
      <Container id="addbookContainer">
        <Row>
          ...
          <Col xs={8}>
            <h1 style={{ textAlign: "center" }}>{t("book.header")}</h1>
          </Col>
          <Col xs={2}>
            <NavDropdown
        ...
        <Form>
          ...
          <Form.Group className="mb-3" controlId="formGridDetail">
            ...
            <Form.Control
              placeholder="Somthing about your book..."
              onChange={onValueChange_detail}
            />
          </Form.Group>
          <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridCountry">
              ...
              <Form.Select
                defaultValue="Choose..."
                onChange={onValueChange_country}
              >
                ...
                <option value="country-other">{t("menu.country-other")}</option>
              </Form.Select>
            </Form.Group>
            <Form.Group as={Col}>
